<div class="modal fade" id="DeleteModalL<?= $row['no']; ?>">
      ...
      <!-- Modal body -->
            <div class="modal-body">
              ...
              <!--lengkapi onclick pada button yes untuk redirect ke kepegawaian/deletemebel/'.$a['id_mebel']  -->
                    <input type="submit" class="btn btn-dark lebar-but" onclick="location.href='<?= site_url('Home/deleteL/'.$row['no']);?> '" value="Yes" />
                    </div>
                </div>
            </div>
        </div>
